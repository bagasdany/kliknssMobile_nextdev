...
class Constants {
  ...
  static const MaterialColor primaryBlack = MaterialColor(
    ...
    <int, Color>{
      ...
      400: Color(0x73000000),
      500: Color(0xff000000),
      600: Color(0x8A000000),
    },
  );
  ...
  static const MaterialColor base = MaterialColor(0xfff8f6f5, <int, Color>{});
  ...
  static const double fontSizeXxs = 6;

  static const Color purple = Color(0xff483091);
  ...
  static const Color slBarColor = Color(0xffCDD2F2);
  ...
  static const Cubic cubicAnimateMediumToFast = Cubic(0.55, 0.055, 0.675, 0.19);
  static const Cubic cubicAnimateSlowToFast = Cubic(0.895, 0.03, 0.685, 0.22);
  static const Cubic cubicAnimateFastToSlow = Cubic(0.215, 0.61, 0.355, 1.0);
  static const Cubic cubicAnimateFastToMedium = Cubic(0.165, 0.84, 0.44, 1.0);
  static const Cubic cubicAnimateSlowestToFast = Cubic(0.99, 0.93, 0.685, 0.22);
  // heading1
  // heading2
  // heading3
  // heading4
