...
import 'm2w_checkout2.dart';

class M2WCheckout1 extends StatefulWidget {
  Map<String, dynamic> order = {};
  Map? kelurahan;

  M2WCheckout1(this.order, {Key? key}) : super(key: key);

  @override
  State<M2WCheckout1> createState() => _M2WCheckout1State();
}

class _M2WCheckout1State extends State<M2WCheckout1> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      noKtp.text = widget.order['customerKtpNumber'] ?? '';
      ...
      AppLog().logScreenView('M2W Checkout 1');
    });
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(_invalids['customerName'] ?? 'Nama Lengkap',
                    style: TextStyle(
                        fontSize: Constants.fontSizeSm,
                ...
                Focus(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        filled: true,
                        fillColor: _text7.text == null || _text7.text == ""
                            ? Constants.white
                ...
                const SizedBox(height: Constants.spacing4),
                Text(_invalids['customerOccupation'] ?? 'Pilih Pekerjaan',
                    style: TextStyle(
                        fontSize: Constants.fontSizeSm,
                        color: _invalids['customerOccupation'] != null
                            ? Constants.primaryColor
                            : Constants.gray)),
                const SizedBox(height: Constants.spacing1),
                buildOccupation(context),
                // const SizedBox(height: Constants.spacing4),
                // Text(_invalids['homeType'] ?? 'Pilih Tipe Rumah',
                //     style: TextStyle(
                //         fontSize: Constants.fontSizeSm,
                //         color: _invalids['homeType'] != null
                //             ? Constants.primaryColor
                //             : Constants.gray)),
                // const SizedBox(height: Constants.spacing1),
                // buildhomeTipe(context),
                // const SizedBox(height: Constants.spacing4),
                // const Text('Lama Tinggal', //homeLivingDuration
                //     style: TextStyle(
                ...
                //         keyboardType: TextInputType.number,
                //         onChanged: (text) {
                //           widget.order['homeLivingDuration'] = _text6.text;
                //           validate();
                //         },
                //         onEditingComplete: () {},
                //       ),
                ...
                //         child: buildLivingDuration(context))
                //   ],
                // ),
                // const SizedBox(height: Constants.spacing4),
                // Text(_invalids['homeOwnership'] ?? 'Tempat Tinggal Atas Nama',
                //     style: TextStyle(
                //         fontSize: Constants.fontSizeSm,
                //         color: _invalids['homeOwnership'] != null
                //             ? Constants.primaryColor
                //             : Constants.gray)),
                // const SizedBox(height: Constants.spacing1),
                // buildhomeOwnership(context),
                const SizedBox(height: Constants.spacing4),
                ...
                Focus(
                  ...
                  child: TextField(
                    readOnly: noKtp.text.isEmpty ? false : true,
                    controller: _text2,
                    keyboardType: TextInputType.number,
                    maxLength: 16,
                    decoration: InputDecoration(
                        filled: true,
                        fillColor: noKtp.text.isEmpty
                            ? Constants.white
                            : Constants.gray.shade100,
                        counterText: '',
                        contentPadding: const EdgeInsets.symmetric(
                ...
                const SizedBox(height: Constants.spacing4),
                Text(_invalids['deliveryAddress'] ?? 'Alamat tempat tinggal',
                    style: TextStyle(
                        fontSize: Constants.fontSizeSm,
                        color: _invalids['deliveryAddress'] != null
                            ? Constants.primaryColor
                            : Constants.gray)),
                const SizedBox(height: Constants.spacing1),
                Focus(
                    onFocusChange: (hasFocus) {
                      if (hasFocus && _inputPhase < 3) {
                        _inputPhase = 3;
                      }
                    },
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                              ...
                              borderRadius: const BorderRadius.all(
                                  Radius.circular(Constants.spacing3)))),
                      onChanged: (text) {
                        widget.order['deliveryAddress'] = _text3.text;
                        validate();
                      },
                    )),
                const SizedBox(height: Constants.spacing4),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: widget.order['deliveryKelurahanName'] == null
                        ? const Text('Tekan untuk memilih Kota/Kecamatan...',
                              ...
                              if (_valid) {
                                ...
                                setState(() {
                                  ...
                                  if (_text4.text.isEmpty ||
                                      widget.order['deliveryKelurahanId'] ==
                                          null ||
                                      _text5.text.isEmpty ||
                                      _text3.text.isEmpty) {
