...
class BankAccountCard extends StatefulWidget {
  ...
  const BankAccountCard({Key? key, this.onChanged}) : super(key: key);
    ...
    return InkWell(
      onTap: () async {
                                    ...
                                    children: [
                                      Container(
                                        padding: const EdgeInsets.all(
                                            Constants.spacing4),
                                        child: const Text(
                                            'Posisikan Buku Tabungan didalam kotak dan tekan tombol kamera',
                                            style: TextStyle(
                                                fontFamily:
        ...
        if (result != null && tipe == 2) {
          ...
          int h = (w / 1).round();
          int x = ((imgWidth - w)).round();
          int y = ((imgHeight - h)).round();
