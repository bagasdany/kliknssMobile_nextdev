...
import 'package:kliknss77/ui/views/agent/m2w/checkout_m2w_agent2.dart';
import 'package:kliknss77/ui/views/ocr/ktp_card.dart';

class M2WAgentCheckout1 extends StatefulWidget {
  Map<String, dynamic> order = {};
  Map? kelurahan;

  M2WAgentCheckout1(this.order, {Key? key}) : super(key: key);

  @override
  State<M2WAgentCheckout1> createState() => _M2WAgentCheckout1State();
}

class _M2WAgentCheckout1State extends State<M2WAgentCheckout1> {
  ...
  Future<void> save(BuildContext context) async {
    ...
    try {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (_) {
        ...
        return M2WAgentCheckout2(order);
      }));
            ...
            child: Column(
              ...
              children: [
                ...
                Focus(
                  ...
                  child: TextField(
                    readOnly: firstKtp == null || firstKtp == "" ? false : true,
                    controller: _text2,
                    keyboardType: TextInputType.number,
                    maxLength: 16,
                    decoration: InputDecoration(
                        filled: true,
                        counterText: '',
                        fillColor: firstKtp == null || firstKtp == ""
                            ? Constants.white
                            : Constants.gray.shade900,
                        contentPadding: const EdgeInsets.symmetric(
                            horizontal: Constants.spacing3),
                ...
                // const SizedBox(height: Constants.spacing4),
                // Text(
                //   _invalids['deliveryAddress'] ?? 'Alamat tempat tinggal',
                //   style: TextStyle(
                //       fontSize: Constants.fontSizeSm,
