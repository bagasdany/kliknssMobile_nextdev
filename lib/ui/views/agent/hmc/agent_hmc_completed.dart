...
class HMCAgentCompleted extends StatefulWidget {
  final data;

  const HMCAgentCompleted({Key? key, required this.data}) : super(key: key);

  @override
  _HMCAgentCompleted createState() => _HMCAgentCompleted();
}

class _HMCAgentCompleted extends State<HMCAgentCompleted> {
  @override
  void initState() {
    super.initState();
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                  'Terima kasih telah melakukan pengajuan motor melalui KlikNSC.',
